...
// Code your solution for part A #2 below this comment (and above the return statement) ... //
  ...
  for (let i = 0; i < pantry.length; i++) {
      let chosenItem = pantry[i];
      let randomIngredient = Math.floor(Math.random() * chosenItem.length);
      mealsGenerated.push(chosenItem[randomIngredient]);
  }
  meals.push(mealsGenerated);
}
  return meals;
}
...
return numMeals;
 ...
 function generatePassword(string1, string2) {
  ...
  let maxLength = string1.length + string2.length;
